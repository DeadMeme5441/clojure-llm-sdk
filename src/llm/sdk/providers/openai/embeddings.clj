(ns llm.sdk.providers.openai.embeddings
...
(defn- normalize-model [profile model]
  (cond
    (and (= :openrouter (:profile/id profile))
         (string? model)
         (str/starts-with? model "openrouter/"))
    (subs model (count "openrouter/"))
